    ...
    <div className="page-content">
      <section className="map-section" id="map">
        <div className="personal-intro">
          ...
          <div><p className="overline">ABOUT ME</p><h1>Hey, I&apos;m Marvin.</h1><p className="intro-role">AI Engineer with a background in SQL Server database systems and production infrastructure.</p><p>Before transitioning into AI, I spent several years working with Microsoft SQL Server in production environments, where I developed experience in database administration, automation, monitoring, performance tuning, backup and recovery, and operational reliability.</p><p>That background influences how I approach AI engineering today—building systems that emphasize reliability, maintainability, observability, and scalability rather than simple demos.</p></div>
        </div>
